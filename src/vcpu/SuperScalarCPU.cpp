...
void SuperScalarCPU::ExecuteBneInstr(InstructionDecoder& instrDecoder) {
...
void SuperScalarCPU::ExecuteBeqInstr(InstructionDecoder& instrDecoder) {
    auto v = instrDecoder.GetValue();
    if (instrDecoder.opArgDst.addrMode != AddressMode::Immediate) {
        // raise exception
        return;
...
void SuperScalarCPU::ExecuteCmpInstr(InstructionDecoder& instrDecoder) {
    auto v = instrDecoder.GetValue();
    if (instrDecoder.opArgDst.addrMode == AddressMode::Immediate) {
        // raise exception
        return;
...
void SuperScalarCPU::ExecuteAslInstr(InstructionDecoder& instrDecoder) {
    auto v = instrDecoder.GetValue();
...
void SuperScalarCPU::ExecuteAsrInstr(InstructionDecoder& instrDecoder) {
    auto v = instrDecoder.GetValue();
    if (instrDecoder.opArgDst.addrMode != AddressMode::Register) {
        // raise exception
        return;
...
void SuperScalarCPU::ExecuteLslInstr(InstructionDecoder& instrDecoder) {
    auto v = instrDecoder.GetValue();
    if (instrDecoder.opArgDst.addrMode != AddressMode::Register) {
        // raise exception
        return;
...
void SuperScalarCPU::ExecuteLsrInstr(InstructionDecoder& instrDecoder) {
    auto v = instrDecoder.GetValue();
    if (instrDecoder.opArgDst.addrMode != AddressMode::Register) {
        // raise exception
        return;
...
//
void SuperScalarCPU::ExecuteSysCallInstr(InstructionDecoder& instrDecoder) {
...
void SuperScalarCPU::ExecutePushInstr(InstructionDecoder& instrDecoder) {
    auto &v = instrDecoder.GetValue();
    // FIXME: this should write to register sp using MMU handling
    stack.push(v);
}

void SuperScalarCPU::ExecutePopInstr(InstructionDecoder& instrDecoder) {
    auto v = stack.top();
    stack.pop();
    WriteToDst(instrDecoder, v);
}

void SuperScalarCPU::ExecuteLeaInstr(InstructionDecoder& instrDecoder) {
    auto &v = instrDecoder.GetValue();
    WriteToDst(instrDecoder, v);
}


void SuperScalarCPU::ExecuteMoveInstr(InstructionDecoder& instrDecoder) {
    auto &v = instrDecoder.GetValue();
    WriteToDst(instrDecoder, v);
}
...
void SuperScalarCPU::ExecuteAddInstr(InstructionDecoder& instrDecoder) {
    auto &v = instrDecoder.GetValue();
...
void SuperScalarCPU::ExecuteSubInstr(InstructionDecoder& instrDecoder) {
    auto &v = instrDecoder.GetValue();
...
void SuperScalarCPU::ExecuteMulInstr(InstructionDecoder& instrDecoder) {

}
void SuperScalarCPU::ExecuteDivInstr(InstructionDecoder& instrDecoder) {

}

void SuperScalarCPU::ExecuteCallInstr(InstructionDecoder& instrDecoder) {
    auto &v = instrDecoder.GetValue();
...
void SuperScalarCPU::ExecuteRetInstr(InstructionDecoder& instrDecoder) {
    if (stack.empty()) {
...
void SuperScalarCPU::ExecuteRtiInstr(InstructionDecoder& instrDecoder) {
...
//
void SuperScalarCPU::WriteToDst(InstructionDecoder& instrDecoder, const RegisterValue &v) {
